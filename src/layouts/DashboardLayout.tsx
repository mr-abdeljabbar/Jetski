  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <aside className="w-72 bg-white shadow-[4px_0_24px_rgba(0,0,0,0.02)] flex flex-col z-10">
        <div className="p-8 pb-6 border-b border-gray-100 flex items-center">
          ...
          <div className="ml-3">
            <div className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold leading-4 bg-sky/10 text-ocean">
              {user.role}
            </div>
          </div>
        </div>
